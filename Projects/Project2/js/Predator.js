...
class Predator {
  ...
  // handleEating
  //
  // Takes a Pokemon as an argument and checks if the Pokeball overlaps it. If so,
  // it reduces the pokemon's health and increases the pokeball's. If a Pokemon is caught, it gets reset.
  handleEating(prey) {
